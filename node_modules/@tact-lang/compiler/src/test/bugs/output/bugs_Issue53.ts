...
function dictValueParserChangeOwnerOk(): DictionaryValue<ChangeOwnerOk> {
 ...
 type Issue53_init_args = {
    $$type: 'Issue53_init_args';
}

function initIssue53_init_args(src: Issue53_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
    };
}
...
const Issue53_errors: { [key: number]: { message: string } } = {
...
const Issue53_getters: ABIGetter[] = [
]

const Issue53_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"empty"}},
]

export class Issue53 implements Contract {
