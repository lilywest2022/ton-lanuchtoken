PROGRAM{
  ...
  DECLPROC ?fun_ref_ca11b76af377de11;
  recv_internal PROC:<{
    s0 s1 XCHG
    CTOS
    4 LDU
    ...
    ROTREV
    ?fun_ref_ca11b76af377de11 INLINECALLDICT
    130 THROWIFNOT
    s0 POP
    NEWC
    3 GETGLOBVAR
  ...
  get_abi_ipfs PROC:<{
    x{697066733A2F2F516D504B7068537543487479685767334653714165556D77614A64437976464A79695A646F6D466746646941385982_} PUSHSLICE
  }>
  ...
  ?fun_ref_ca11b76af377de11 PROCREF:<{
    s0 s1 XCHG
    <{
      s0 POP
      -1 PUSHINT
