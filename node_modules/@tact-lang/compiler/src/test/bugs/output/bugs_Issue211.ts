...
function dictValueParserChangeOwnerOk(): DictionaryValue<ChangeOwnerOk> {
 ...
 type Issue211_init_args = {
    $$type: 'Issue211_init_args';
}

function initIssue211_init_args(src: Issue211_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
    };
}
...
const Issue211_errors: { [key: number]: { message: string } } = {
...
const Issue211_getters: ABIGetter[] = [
...
const Issue211_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"empty"}},
]

export class Issue211 implements Contract {
