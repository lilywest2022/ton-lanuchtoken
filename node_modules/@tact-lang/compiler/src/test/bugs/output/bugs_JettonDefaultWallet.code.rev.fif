PROGRAM{
  ...
  DECLPROC ?fun_ref_1b37229bf0e2edc1;
  ...
  DECLPROC ?fun_ref_97135407d7422d8f;
  ...
  recv_internal PROC:<{
    ...
    2 3 BLKSWAP
    ?fun_ref_1b37229bf0e2edc1 INLINECALLDICT
    130 THROWIFNOT
    NEWC
    3 GETGLOBVAR
    s0 s1 XCHG
  ...
  get_abi_ipfs PROC:<{
    x{697066733A2F2F516D626F6A485254434263636F79354E6D76416A713667414E516F65675A626A6B6E727A7032484339394656486D82_} PUSHSLICE
  }>
  ...
  ?fun_ref_1b37229bf0e2edc1 PROCREF:<{
    s0 s1 XCHG
    <{
      32 PUSHINT
      SDSKIPFIRST
    ...
    <{
      s0 POP
      ?fun_ref_e909b9b42570c1ee INLINECALLDICT
      1 6 BLKDROP2
      ?fun_ref_97135407d7422d8f INLINECALLDICT
      -1 PUSHINT
    }> IFJMPREF
    1499400124 PUSHINT
    EQUAL
  ...
  ?fun_ref_2accad73d60fa883 PROCREF:<{
    c4 PUSH
    CTOS
    LDREF
    s0 s1 XCHG
    ...
    ENDS
    s0 s1 XCHG
    ?fun_ref_5007013235aab4c2 INLINECALLDICT
  }>
  ?fun_ref_5007013235aab4c2 PROCREF:<{
    0 PUSHINT
    s0 s2 XCHG
  }>
  ...
  ?fun_ref_97135407d7422d8f PROCREF:<{
    1 GETGLOBVAR
    4 UNTUPLE
    s10 s2 PUSH2
    SDEQ
  ...
  ?fun_ref_e909b9b42570c1ee PROCREF:<{
    32 LDU
    s0 s1 XCHG
    395134233 PUSHINT
    EQUAL
