PROGRAM{
  ...
  DECLPROC ?fun_ref_65eeca6fa780a4bd;
  ...
  recv_internal PROC:<{
    ...
    2 5 BLKSWAP
    ?fun_ref_65eeca6fa780a4bd INLINECALLDICT
    130 THROWIFNOT
    NEWC
    3 GETGLOBVAR
    s0 s1 XCHG
  ...
  get_abi_ipfs PROC:<{
    x{697066733A2F2F516D595754657734395A5651625646424765324E387832656B36584A34585339764B6D764379797473657870626E82_} PUSHSLICE
  }>
  ?fun_ref_25011c0bed620945 PROCREF:<{
    0 PUSHINT
    s1 s3 s3 XCHG3
    -1 PUSHINT
  }>
  ...
  ?fun_ref_500c43b8824042b8 PROCREF:<{
    c4 PUSH
    CTOS
    LDREF
    s0 s1 XCHG
    ...
    ENDS
    ROT
    ?fun_ref_25011c0bed620945 INLINECALLDICT
  }>
  ?fun_ref_65eeca6fa780a4bd PROCREF:<{
    2 SAVE
    SAMEALTSAVE
    s0 s1 XCHG
    <{
  ...
  ?fun_ref_e20f9805701a7fc5 PROCREF:<{
    6898 PUSHINT
    s8 s2 PUSH2
    ADD
    s8 PUSH
