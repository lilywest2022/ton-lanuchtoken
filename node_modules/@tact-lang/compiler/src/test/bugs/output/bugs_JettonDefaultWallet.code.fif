PROGRAM{
  ...
  DECLPROC $JettonDefaultWallet$_fun_msgValue
  ...
  DECLPROC $TokenBurnNotification$_constructor_queryId_amount_owner_response_destination
  ...
  $JettonDefaultWallet$_fun_msgValue PROCREF:<{
  ...
  $TokenBurnNotification$_constructor_queryId_amount_owner_response_destination PROCINLINE:<{
  }>
  ...
  $JettonDefaultWallet$_internal_binary_TokenTransferInternal PROCINLINE:<{
    ...
    s1 s8 s7 XCHG3
    s4 PUSH
    $JettonDefaultWallet$_fun_msgValue INLINECALLDICT
    s3 s8 XCHG
    s6 s5 s10 XCHG3
    $Context$_fun_readForwardFee INLINECALLDICT
    s7 s6 XCHG2
  ...
  $JettonDefaultWallet$_internal_binary_TokenBurn PROCINLINE:<{
    ...
    TRUE
    s3 s6 s6 XCPU2
    $TokenBurnNotification$_constructor_queryId_amount_owner_response_destination INLINECALLDICT
  ...
  get_abi_ipfs PROC:<{
    x{697066733a2f2f516d626f6a485254434263636f79354e6d76416a713667414e516f65675a626a6b6e727a7032484339394656486d} PUSHSLICE
  }>
