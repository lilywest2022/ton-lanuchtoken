PROGRAM{
  ...
  recv_internal PROC:<{
    ...
    s0 s2 XCHG
    2 SETGLOBVAR
    ?fun_ref_2005ab60a835a763 INLINECALLDICT
    2 9 BLKSWAP
    ?fun_ref_d64238920ad08f80 INLINECALLDICT
    130 THROWIFNOT
    NEWC
    3 GETGLOBVAR
    s0 s1 XCHG
  ...
  get_abi_ipfs PROC:<{
    x{697066733A2F2F516D57796469454B4E4D68517255473239476A537A6E4552343354483879394B6B7861397241366E47485678725582_} PUSHSLICE
  }>
  ?fun_123932 PROC:<{
    ?fun_ref_2005ab60a835a763 INLINECALLDICT
  ...
  ?fun_ref_2005ab60a835a763 PROCREF:<{
    c4 PUSH
    CTOS
    LDREF
    s0 s1 XCHG
    ...
    EQUAL
    137 THROWIFNOT
    ?fun_ref_627092810dc2e084 INLINECALLDICT
    s0 s9 XCHG
    ENDS
    1 8 BLKSWAP
  }>
  ...
  ?fun_ref_627092810dc2e084 PROCREF:<{
    257 PUSHINT
    LDIX
    257 PUSHINT
    LDIX
  ...
  ?fun_ref_d64238920ad08f80 PROCREF:<{
    s0 s1 XCHG
    <{
      s0 POP
      -1 PUSHINT
