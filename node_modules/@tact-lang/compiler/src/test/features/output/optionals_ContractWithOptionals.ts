...
export function loadOptAddr(slice: Slice) {
    ...
    let _x = sc_0.loadUintBig(8);
    let _y = sc_0.loadMaybeAddress();
    let _z = sc_0.loadUintBig(16);
    return { $$type: 'OptAddr' as const, x: _x, y: _y, z: _z };
}

function loadTupleOptAddr(source: TupleReader) {
    let _x = source.readBigNumber();
    let _y = source.readAddressOpt();
    let _z = source.readBigNumber();
    return { $$type: 'OptAddr' as const, x: _x, y: _y, z: _z };
}
...
async function ContractWithOptionals_init(a: bigint | null, b: boolean | null, c: Cell | null, d: Address | null, e: SomeGenericStruct | null, f: StructWithOptionals | null) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
