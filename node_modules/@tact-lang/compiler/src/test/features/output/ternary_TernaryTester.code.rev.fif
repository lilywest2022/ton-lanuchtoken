PROGRAM{
  ...
  ?fun_86564 PROC:<{
    ?fun_ref_a05e0042bce184fb INLINECALLDICT
    ?fun_ref_8810e73f1aa91ec4 INLINECALLDICT
    s1 POP
  }>
  ?fun_90695 PROC:<{
    ?fun_ref_a05e0042bce184fb INLINECALLDICT
  ...
  ?fun_107552 PROC:<{
    ?fun_ref_a05e0042bce184fb INLINECALLDICT
    s0 s1 XCHG
    ?fun_ref_93db61788f47c8df INLINECALLDICT
    s1 POP
  }>
  ...
  get_abi_ipfs PROC:<{
    x{697066733A2F2F516D59565648367A6D554B74737543745872776265424653646D616B627072786F5978784B356F4B44397346785A82_} PUSHSLICE
  }>
  ...
  ?fun_ref_8810e73f1aa91ec4 PROCREF:<{
    1 PUSHINT
  }>
  ?fun_ref_93db61788f47c8df PROCREF:<{
    s0 PUSH
    1 EQINT
    <{
      s0 POP
