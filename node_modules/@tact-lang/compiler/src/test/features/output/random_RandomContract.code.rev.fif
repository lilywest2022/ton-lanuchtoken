PROGRAM{
  ...
  ?fun_92013 PROC:<{
    ?fun_ref_a05e0042bce184fb INLINECALLDICT
    ROTREV
    ?fun_ref_2d07f38171ff8546 INLINECALLDICT
    s1 POP
  }>
  ...
  get_abi_ipfs PROC:<{
    x{697066733A2F2F516D53744250454A71525A6166663375366F77423658726837614E335535714574626B776370744670546D66334582_} PUSHSLICE
  }>
  ?fun_128647 PROC:<{
    ?fun_ref_a05e0042bce184fb INLINECALLDICT
  ...
  ?fun_ref_2d07f38171ff8546 PROCREF:<{
    4 GETGLOBVAR
    ISNULL
    <{
      LTIME
