...
int __tact_log2(int num) asm "DUP 5 THROWIFNOT UBITSIZE DEC";

int __tact_log(int num, int base) inline_ref {
...
int __tact_pow(int base, int exp) inline_ref {
...
int __tact_pow2(int exp) asm "POW2";
