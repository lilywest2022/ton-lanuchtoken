...
function dictValueParserTestMessage(): DictionaryValue<TestMessage> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeTestMessage(src)).endCell());
        },
        parse: (src) => {
