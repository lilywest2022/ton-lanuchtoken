...
#include "masterchain_MasterchainTester.headers.fc";
#include "masterchain_MasterchainTester.stdlib.fc";
#include "masterchain_MasterchainTester.storage.fc";
...
_ get_abi_ipfs() method_id {
    return "ipfs://QmWSTsZGAGr16rRyvUrUg6PNMLFkauXAp2YyVXajyQus6v";
}
