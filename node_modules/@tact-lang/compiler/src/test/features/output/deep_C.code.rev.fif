PROGRAM{
  ...
  recv_internal PROC:<{
    ...
    ROTREV
    ?fun_ref_b95799f0a9207f78 INLINECALLDICT
    130 THROWIFNOT
    NEWC
    3 GETGLOBVAR
    s0 s1 XCHG
  ...
  get_abi_ipfs PROC:<{
    x{697066733A2F2F516D596E526F43346F3635585773797938726A735A6E6776706752506E4E6477475569695876774645756741336382_} PUSHSLICE
  }>
  ...
  ?fun_ref_b95799f0a9207f78 PROCREF:<{
    2 SAVE
    SAMEALTSAVE
    s0 s1 XCHG
    <{
    ...
    <{
      ...
      <{
        ...
        66 PUSHINT
        -1 PUSHINT
        x{000000004D65737361676532} PUSHREF
        4 3 REVERSE
        s4 s3 s0 XCHG3
        s1 s2 XCHG
        s3 s6 XCHG
