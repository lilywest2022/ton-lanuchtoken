PROGRAM{
  ...
  ?fun_74415 PROC:<{
    ?fun_ref_a05e0042bce184fb INLINECALLDICT
    s0 s1 XCHG
    ?fun_ref_94fd608d2afcf8f1 INLINECALLDICT
    s1 POP
  }>
  ?fun_97933 PROC:<{
    ?fun_ref_a05e0042bce184fb INLINECALLDICT
    s0 s1 XCHG
    ?fun_ref_68f50267c8c55b45 INLINECALLDICT
    s1 POP
  }>
  ?fun_103737 PROC:<{
    ?fun_ref_a05e0042bce184fb INLINECALLDICT
  ...
  ?fun_114271 PROC:<{
    ?fun_ref_a05e0042bce184fb INLINECALLDICT
    s0 s1 XCHG
    ?fun_ref_276042a605bab842 INLINECALLDICT
    s1 POP
  }>
  ...
  get_abi_ipfs PROC:<{
    x{697066733A2F2F516D576E445231566645347434386E6D7863555855574A387A68477A47486B4B646F6942615239476255734D317382_} PUSHSLICE
  }>
  dnsresolve PROC:<{
    ?fun_ref_a05e0042bce184fb INLINECALLDICT
    ROTREV
    ?fun_ref_44a5603735516a00 INLINECALLDICT
    1 2 BLKDROP2
  }>
  ...
  ?fun_ref_276042a605bab842 PROCREF:<{
    33 CALL
  }>
  ...
  ?fun_ref_44a5603735516a00 PROCREF:<{
    0 PUSHINT
    s2 PUSH
    8 PLDU
    0 EQINT
    ...
    THROWANYIFNOT
    3 1 BLKSWAP
    ?fun_ref_f1b9d3edc5e7c3f8 INLINECALLDICT
    s0 s3 XCHG
    ADD
    ROT
  }>
  ...
  ?fun_ref_68f50267c8c55b45 PROCREF:<{
    31 CALL
  }>
  ?fun_ref_94fd608d2afcf8f1 PROCREF:<{
    32 CALL
  }>
  ...
  ?fun_ref_f1b9d3edc5e7c3f8 PROCREF:<{
    s0 POP
    s0 PUSH
    SBITS
    NEWC
