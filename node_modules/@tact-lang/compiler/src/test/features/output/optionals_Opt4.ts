...
const Opt4_getters: ABIGetter[] = [
    {"name":"z","arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
]
...
export class Opt4 implements Contract {
    ...
    static async fromInit() {
        const init = await Opt4_init();
        const address = contractAddress(0, init);
        return new Opt4(address, init);
    }
    ...
    async getZ(provider: ContractProvider) {
        let builder = new TupleBuilder();
        let source = (await provider.get('z', builder.build())).stack;
