PROGRAM{
  ...
  DECLPROC $B$_internal_text_b41a9933301c1d728e64e23685fe3a9c7540ab9359ef7318943c0ee5e0910d5d
  ...
  $B$_internal_text_b41a9933301c1d728e64e23685fe3a9c7540ab9359ef7318943c0ee5e0910d5d PROCINLINE:<{
    __tact_context_sys GETGLOB
    MYADDR
    $C$_init_child INLINECALLDICT
    2DUP
  ...
  get_abi_ipfs PROC:<{
    x{697066733a2f2f516d586653417174694b436341383454583339396f3251446933524b595944634452384c6f514464726d71466674} PUSHSLICE
  }>
  ...
  $B$_contract_router_internal PROCREF:<{
    ...
    IF:<{
      ...
      EQUAL
      IFJMP:<{
        $B$_internal_text_b41a9933301c1d728e64e23685fe3a9c7540ab9359ef7318943c0ee5e0910d5d INLINECALLDICT
        TRUE
        RETALT
      }>
    }>ELSE<{
