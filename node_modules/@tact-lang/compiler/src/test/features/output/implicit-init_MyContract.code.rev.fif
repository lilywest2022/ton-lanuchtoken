PROGRAM{
  ...
  DECLPROC ?fun_ref_df5396d9c1e677c7;
  ...
  recv_internal PROC:<{
    ...
    ROTREV
    ?fun_ref_df5396d9c1e677c7 INLINECALLDICT
    130 THROWIFNOT
    NEWC
    3 GETGLOBVAR
    s0 s1 XCHG
  ...
  get_abi_ipfs PROC:<{
    x{697066733A2F2F516D524D37375870714D72414E774C45384B33413238376A5A48767551534C72373678594D32656138775A5A383982_} PUSHSLICE
  }>
  ...
  ?fun_ref_df5396d9c1e677c7 PROCREF:<{
    2 SAVE
    SAMEALTSAVE
    s0 s1 XCHG
    <{
