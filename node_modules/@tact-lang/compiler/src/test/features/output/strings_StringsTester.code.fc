...
(tuple, slice) $StringsTester$_fun_stringWithEscapedChars1(tuple $self) impure inline_ref {
    var ($self) = $self;
    return ($self, __gen_slice_string_e95a6800c2ff3215be0b36a0bb4bed34103e24d83998500771f034ba6ff2bf89());
}

(tuple, slice) $StringsTester$_fun_stringWithEscapedChars2(tuple $self) impure inline_ref {
    var ($self) = $self;
    return ($self, __gen_slice_string_c609f9da73ed498b7e1fac50820669c370b61440c79372f9d0ffd20f8b8249ce());
}

(tuple, slice) $StringsTester$_fun_stringWithEscapedChars3(tuple $self) impure inline_ref {
    var ($self) = $self;
    return ($self, __gen_slice_string_124b0fd1c54de91e181ac7038e4eddd884f9145097b6a2abb0d7d5788b706997());
}

(tuple, slice) $StringsTester$_fun_stringWithEscapedChars4(tuple $self) impure inline_ref {
    var ($self) = $self;
    return ($self, __gen_slice_string_8949cb84acfe46cc8be708af5f8e6a7bb45d7b4492991e1f21129e159e68b8f9());
}

(tuple, slice) $StringsTester$_fun_stringWithAddress(tuple $self) impure inline_ref {
    var ($self) = $self;
    return ($self, __tact_address_to_user_friendly(__gen_slice_address_91f149c50d8445a06cffd875e02ab7777b172ad62464c2492d41da881eddab43()));
}
...
_ get_abi_ipfs() method_id {
    return "ipfs://QmRtMAbf8DXj4aSYZ3oiWMWak93z2syPkgfUkiAHN5BjDv";
}
