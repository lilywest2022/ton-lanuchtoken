...
#include "case-3_SampleContract.headers.fc";
...
((int, int, (int, int)), int) $SampleContract$_fun_stake((int, int, (int, int)) $self) impure inline_ref {
    var (($self'a, $self'b, ($self'c'a, $self'c'b))) = $self;
    return (($self'a, $self'b, ($self'c'a, $self'c'b)), $self'a);
}
...
_ get_abi_ipfs() method_id {
    return "ipfs://QmcdD4Br94XGTsk4ZDM27xGNADD3iYSBHEYoCGwAPZQSMm";
}
...
((int, int, (int, int)), int) $SampleContract$_contract_router_internal((int, int, (int, int)) self, int msg_bounced, slice in_msg) impure inline_ref {
