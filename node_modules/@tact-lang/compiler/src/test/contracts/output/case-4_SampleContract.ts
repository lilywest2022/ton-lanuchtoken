...
function dictValueParserSource(): DictionaryValue<Source> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeSource(src)).endCell());
        },
        parse: (src) => {
