...
semantics.addOperation("astOfModuleItem", {
    Import(_importKwd, path, _semicolon) {
        ...
        if (pathAST.value.indexOf("\\") >= 0) {
            (0, ast_1.throwError)('Import path can\'t contain "\\"', (0, ast_1.createRef)(path));
        }
        return (0, ast_1.createNode)({
            kind: "program_import",
            path: pathAST,
    ...
    NativeFunctionDecl(_name, _lparen1, funcId, _rparen1, funAttributes, _nativeKwd, tactId, _lparen2, params, optTrailingComma, _rparen2, _optColon, optReturnType, _semicolon) {
        if (params.source.contents === "" &&
            optTrailingComma.sourceString === ",") {
            (0, ast_1.throwError)("Empty parameter list should not have a dangling comma.", (0, ast_1.createRef)(optTrailingComma));
        }
    ...
    Contract(attributes, _contractKwd, contractId, _optWithKwd, optInheritedTraits, _optTrailingComma, _lbrace, contractItems, _rbrace) {
        ...
        return (0, ast_1.createNode)({
            ...
            traits: optInheritedTraits.children[0]
                ?.asIteration()
                .children.map((e) => e.astOfExpression()) ?? [],
            ref: (0, ast_1.createRef)(this),
        });
    },
    Trait(attributes, _traitKwd, traitId, _optWithKwd, optInheritedTraits, _optTrailingComma, _lbrace, traitItems, _rbrace) {
...
semantics.addOperation("astOfItem", {
    ...
    FunctionDefinition(funAttributes, _funKwd, funId, _lparen, funParameters, optTrailingComma, _rparen, _optColon, optReturnType, _lbrace, funBody, _rbrace) {
        if (funParameters.source.contents === "" &&
            optTrailingComma.sourceString === ",") {
            (0, ast_1.throwError)("Empty parameter list should not have a dangling comma.", (0, ast_1.createRef)(optTrailingComma));
        }
    ...
    FunctionDeclaration(funAttributes, _funKwd, funId, _lparen, funParameters, optTrailingComma, _rparen, _optColon, optReturnType, _semicolon) {
        if (funParameters.source.contents === "" &&
            optTrailingComma.sourceString === ",") {
            (0, ast_1.throwError)("Empty parameter list should not have a dangling comma.", (0, ast_1.createRef)(optTrailingComma));
        }
    ...
    ContractInit(_initKwd, _lparen, initParameters, optTrailingComma, _rparen, _lbrace, initBody, _rbrace) {
        if (initParameters.source.contents === "" &&
            optTrailingComma.sourceString === ",") {
            (0, ast_1.throwError)("Empty parameter list should not have a dangling comma.", (0, ast_1.createRef)(optTrailingComma));
        }
        return (0, ast_1.createNode)({
...
semantics.addOperation("astOfDeclaration", {
    FieldDecl(id, _colon, type, _optAs, optStorageType, _optEq, optInitializer, _semicolon) {
        return (0, ast_1.createNode)({
            kind: "def_field",
...
semantics.addOperation("astOfStatement", {
    ...
    StatementUntil(_doKwd, _lbrace, loopBody, _rbrace, _untilKwd, _lparen, condition, _rparen, _semicolon) {
        return (0, ast_1.createNode)({
...
semantics.addOperation("astOfExpression", {
    ...
    ExpressionMethodCall(source, _dot, methodId, _lparen, methodArguments, optTrailingComma, _rparen) {
        if (methodArguments.source.contents === "" &&
            optTrailingComma.sourceString === ",") {
            (0, ast_1.throwError)("Empty parameter list should not have a dangling comma.", (0, ast_1.createRef)(optTrailingComma));
        }
        return (0, ast_1.createNode)({
    ...
    ExpressionStaticCall(functionId, _lparen, functionArguments, optTrailingComma, _rparen) {
        if (functionArguments.source.contents === "" &&
            optTrailingComma.sourceString === ",") {
            (0, ast_1.throwError)("Empty parameter list should not have a dangling comma.", (0, ast_1.createRef)(optTrailingComma));
        }
        return (0, ast_1.createNode)({
    ...
    ExpressionInitOf(_initOfKwd, contractId, _lparen, initArguments, optTrailingComma, _rparen) {
        if (initArguments.source.contents === "" &&
            optTrailingComma.sourceString === ",") {
            (0, ast_1.throwError)("Empty parameter list should not have a dangling comma.", (0, ast_1.createRef)(optTrailingComma));
        }
        return (0, ast_1.createNode)({
