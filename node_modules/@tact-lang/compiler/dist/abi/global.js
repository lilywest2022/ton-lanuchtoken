    ...
    [
        "ton",
        {
            ...
            generate: (ctx, args, resolved, ref) => {
                ...
                const str = (0, resolveConstantValue_1.resolveConstantValue)({ kind: "ref", name: "String", optional: false }, resolved[0], ctx.ctx);
    ...
    [
        "require",
        {
            ...
            generate: (ctx, args, resolved, ref) => {
                ...
                const str = (0, resolveConstantValue_1.resolveConstantValue)({ kind: "ref", name: "String", optional: false }, resolved[1], ctx.ctx);
        ...
        "address",
        {
            ...
            generate: (ctx, args, resolved, ref) => {
                ...
                try {
                    ...
                    (0, ast_1.throwError)(`${str} is not a valid address`, ref);
                }
    ...
    [
        "dumpStack",
        {
            ...
            resolve: (_ctx, args, ref) => {
                if (args.length !== 0) {
                    (0, ast_1.throwError)("dumpStack expects no arguments", ref);
                }
                return { kind: "void" };
            },
