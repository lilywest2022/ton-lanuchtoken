...
exports.SampleContract = exports.loadSource = exports.storeSource = exports.loadSendParameters = exports.storeSendParameters = exports.loadContext = exports.storeContext = exports.loadStateInit = exports.storeStateInit = void 0;
...
function loadSource(slice) {
    let sc_0 = slice;
    let _a = sc_0.loadIntBig(257);
    let _b = sc_0.loadIntBig(257);
    return { $$type: 'Source', a: _a, b: _b };
}
exports.loadSource = loadSource;
function loadTupleSource(source) {
    let _a = source.readBigNumber();
    let _b = source.readBigNumber();
    return { $$type: 'Source', a: _a, b: _b };
}
function storeTupleSource(source) {
    let builder = new core_1.TupleBuilder();
    builder.writeNumber(source.a);
    builder.writeNumber(source.b);
    return builder.build();
}
function dictValueParserSource() {
    return {
        serialize: (src, builder) => {
            builder.storeRef((0, core_1.beginCell)().store(storeSource(src)).endCell());
        },
        parse: (src) => {
...
async function SampleContract_init() {
    ...
    const __system = core_1.Cell.fromBase64('');
