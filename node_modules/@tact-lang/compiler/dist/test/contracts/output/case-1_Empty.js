...
exports.Empty = exports.loadSource = exports.storeSource = exports.loadSendParameters = exports.storeSendParameters = exports.loadContext = exports.storeContext = exports.loadStateInit = exports.storeStateInit = void 0;
...
function loadSource(slice) {
    ...
    return { $$type: 'Source', a: _a, b: _b, c: _c, d: _d };
}
...
function initEmpty_init_args(src) {
    return (builder) => {
        let b_0 = builder;
    };
}
