...
const Issue53_getters = [];
const Issue53_receivers = [
    { "receiver": "internal", "message": { "kind": "empty" } },
];
class Issue53 {
    static async init() {
        return await Issue53_init();
    }
    static async fromInit() {
        const init = await Issue53_init();
        const address = (0, core_1.contractAddress)(0, init);
        return new Issue53(address, init);
    }
    static fromAddress(address) {
        return new Issue53(address);
    }
    address;
    init;
    abi = {
        types: Issue53_types,
        getters: Issue53_getters,
        receivers: Issue53_receivers,
        errors: Issue53_errors,
    };
