...
const Issue211_getters = [
    { "name": "test1", "arguments": [], "returnType": { "kind": "simple", "type": "int", "optional": false, "format": 257 } },
    { "name": "test2", "arguments": [], "returnType": { "kind": "simple", "type": "int", "optional": false, "format": 257 } },
    { "name": "test3", "arguments": [], "returnType": { "kind": "simple", "type": "int", "optional": false, "format": 257 } },
    { "name": "test4", "arguments": [], "returnType": { "kind": "simple", "type": "int", "optional": false, "format": 257 } },
    { "name": "test5", "arguments": [], "returnType": { "kind": "simple", "type": "int", "optional": false, "format": 257 } },
    { "name": "test6", "arguments": [], "returnType": null },
    { "name": "test7", "arguments": [], "returnType": { "kind": "simple", "type": "int", "optional": false, "format": 257 } },
    { "name": "test8", "arguments": [], "returnType": { "kind": "simple", "type": "int", "optional": false, "format": 257 } },
    { "name": "test9", "arguments": [], "returnType": { "kind": "simple", "type": "int", "optional": false, "format": 257 } },
];
const Issue211_receivers = [
    { "receiver": "internal", "message": { "kind": "empty" } },
];
class Issue211 {
    static async init() {
        return await Issue211_init();
    }
    static async fromInit() {
        const init = await Issue211_init();
        const address = (0, core_1.contractAddress)(0, init);
        return new Issue211(address, init);
    }
    static fromAddress(address) {
        return new Issue211(address);
    }
    address;
    init;
    abi = {
        types: Issue211_types,
        getters: Issue211_getters,
        receivers: Issue211_receivers,
        errors: Issue211_errors,
    };
    ...
    async getTest1(provider) {
        let builder = new core_1.TupleBuilder();
        let source = (await provider.get('test1', builder.build())).stack;
        let result = source.readBigNumber();
        return result;
    }
    async getTest2(provider) {
        let builder = new core_1.TupleBuilder();
        let source = (await provider.get('test2', builder.build())).stack;
        let result = source.readBigNumber();
        return result;
    }
    async getTest3(provider) {
        let builder = new core_1.TupleBuilder();
        let source = (await provider.get('test3', builder.build())).stack;
        let result = source.readBigNumber();
        return result;
    }
    async getTest4(provider) {
        let builder = new core_1.TupleBuilder();
        let source = (await provider.get('test4', builder.build())).stack;
        let result = source.readBigNumber();
        return result;
    }
    async getTest5(provider) {
        let builder = new core_1.TupleBuilder();
        let source = (await provider.get('test5', builder.build())).stack;
        let result = source.readBigNumber();
        return result;
    }
    async getTest6(provider) {
        let builder = new core_1.TupleBuilder();
        let source = (await provider.get('test6', builder.build())).stack;
    }
    async getTest7(provider) {
        let builder = new core_1.TupleBuilder();
        let source = (await provider.get('test7', builder.build())).stack;
        let result = source.readBigNumber();
        return result;
    }
    async getTest8(provider) {
        let builder = new core_1.TupleBuilder();
        let source = (await provider.get('test8', builder.build())).stack;
        let result = source.readBigNumber();
        return result;
    }
    async getTest9(provider) {
        let builder = new core_1.TupleBuilder();
        let source = (await provider.get('test9', builder.build())).stack;
        let result = source.readBigNumber();
        return result;
    }
}
exports.Issue211 = Issue211;
