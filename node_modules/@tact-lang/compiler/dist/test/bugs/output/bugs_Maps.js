...
class Maps {
    ...
    async getAllItems(provider) {
        ...
        let result = core_1.Dictionary.loadDirect(core_1.Dictionary.Keys.Address(), dictValueParserTokenInfo(), source.readCellOpt());
        return result;
    }
}
exports.Maps = Maps;
