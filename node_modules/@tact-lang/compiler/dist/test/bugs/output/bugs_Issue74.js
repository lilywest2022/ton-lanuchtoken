...
class Issue74 {
    ...
    static async fromInit() {
        const init = await Issue74_init();
        const address = (0, core_1.contractAddress)(0, init);
        return new Issue74(address, init);
    }
